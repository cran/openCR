...
Previous versions of **openCR** included the function `ucare.cjs` as a wrapper for relevant functions in **R2ucare**. This has been suspended, perhaps temporarily, owing to the removal of **R2ucare** from CRAN.
...
Gimenez, O., Lebreton, J.-D., Choquet, R. and Pradel, R. (2017) R2ucare: 
  Goodness-of-Fit Tests for Capture-Recapture Models. R package version 1.0.0. 
